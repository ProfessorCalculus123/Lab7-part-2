    ...
    <article>
        <form id="regform" method="post" action="processbooking.php" novalidate="novalidate">
            <fieldset id="person">
                ...
                <p><label for="lastname">Enter your Lastname</label>
			...
			<option value="cram">Cram</option>
                ...
                <p>
                    <!-- Firefox does not support the HTML5 date input yet so we need to use text -->
                    <label for="date">Date</label>
                    <input type="text" id="date" name="bookday" maxlength="10" size="10" />
                </p>
                <p>
